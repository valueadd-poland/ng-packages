...
export function writeToFile(filePath, str) {
 ...
 */
export function updateJsonFile(filePath, callback) {
    const json = readJsonFile(filePath);
    callback(json);
    writeJsonFile(filePath, json);
}
export function addApp(apps, newApp) {
    if (!apps) {
        apps = [];
    }
    apps.push(newApp);
...
export function readCliConfigFile() {
    return readJsonFile('.angular-cli.json');
}
export function copyFile(file, target) {
...
export function renameSync(from, to, cb) {
    try {
