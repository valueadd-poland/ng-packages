...
export function insertConstructorArguments(host, filePath, ctorArguments) {
    ...
    if (!ctorNode) {
        ...
        insert(host, filePath, [
            addConstructorArgument(filePath, ctorNode, ctorArguments.shift())
        ]);
        insertConstructorArguments(host, filePath, ctorArguments);
    }
}
export function addConstructorArgument(filePath, ctorNode, ctorArgument) {
...
export function createConstructorForInjection(filePath, sourceFile, ctorArguments = []) {
    const nodes = getSourceNodes(sourceFile);
...
//# sourceMappingURL=constructor.utils.js.map