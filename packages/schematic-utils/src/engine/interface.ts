...
export interface TaskConfiguration<T = unknown> {
  name: string;
  dependencies?: Array<TaskId>;
  options?: T;
}

export interface TaskConfigurationGenerator<T = unknown> {
...
export interface EngineHost<
  CollectionMetadataT extends unknown,
  SchematicMetadataT extends unknown
> {
  ...
  getSchematicRuleFactory<OptionT extends unknown>(
...
> {
  ...
  transformOptions<OptionT extends unknown, ResultT extends unknown>(
    schematic: Schematic<CollectionMetadataT, SchematicMetadataT>,
    options: OptionT,
    context?: TypedSchematicContext<CollectionMetadataT, SchematicMetadataT>
  ): Observable<ResultT>;
