...
declare const window: { Symbol: { schematicTree: symbol }; window: any };
declare const self: { Symbol: { schematicTree: symbol }; self: any };
declare const global: { Symbol: { schematicTree: symbol }; global: any };

export const TreeSymbol: symbol = (function (): any {
  const globalSymbol =
...
namespace Tree {
  export function isTree(maybeTree: any): maybeTree is Tree {
