...
export class ValidationMessagesService {
  ...
  getValidatorErrorMessage(
    ...
    if (validatorName === "pattern") {
      ...
      return (cache[cacheKey] = this.validationMessagesFinalConfig[
        validatorName
      ][validatorValue.requiredPattern].message);
    }
  ...
  setServerMessagesParser(
    serverMessageParser: ValidationMessageParser | null
  ): void {
